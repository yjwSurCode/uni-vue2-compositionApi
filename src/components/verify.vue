...
export default {
  ...
  methods: {
    ...
    draw() {
      ...
      //S   const ctx = this.$refs.verify.getContext('2d')

    //   console.log('this.$refs.verify',ctxD,document.getElementsByClassName("canvasc")[0],this.$refs.verify,this.$refs.verify.createC)
