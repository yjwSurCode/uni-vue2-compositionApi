    ...
    <view class="form" :style="{ position: 'relative', top: '-1px' }">
      <view class="box">
        ...
        <view v-show="!showHistory" class="animation-fade">
          ...
          <view class="input-wrapper">
            <image class="phone-image" src="../../static/image/pwd.svg" />
            <input type="text" password class="input" v-model="loginForm.password" placeholder="请确认您的密码" />
          </view>
          <!-- <view class="input-wrapper">
          ...
          <!-- <view class="block-item">
            ...
            <u-dropdown-item v-model="unwantedValue" title="距离" :options="unwantedOptions"></u-dropdown-item>
            1
          </view> -->

          <uni-section title="部门 " type="line" :style="{ marginBottom: '20px' }">
          ...
          <uni-section title="性别 " type="line" :style="{ marginBottom: '30px' }">
        ...
        <view class="third-login">
          <view class="text-grey">—— 绑定第三方账号注册 ——</view>
          <view class="provider">
            <view
